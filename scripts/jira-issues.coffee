              ...
              .get() (err, res, body) ->
                try
                  ...
                  message = {
                    "attachments": [
                      {
                        "title": "[<http://cagedata.atlassian.net/browse/IPI-1067|IPI-1067>] Laptop Screen - White Line",
                        "pretext": "",
                        "text": "*Type:* IT Help\t*Priority:* Major*Status:* Waiting for Support\t*Assignee:* Chris Totzke",
                        "mrkdwn_in": [
                          "text",
                          "pretext"
                        ]
